                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <?php foreach ($submenu_join as $sbmj) : ?>
                                <tr>
                                    ...
                                    <td><?= $sbmj['url'] ?></td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#ubah_modal<?= $sbmj['submenuid'] ?>">Edit</a>
                                        <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#hapus_modal<?= $sbmj['submenuid'] ?>">Hapus</a>
                                    </td>
                                </tr>


                                <!-- Modal Ubah -->
                                <div class="modal fade" id="ubah_modal<?= $sbmj['submenuid'] ?>" tabindex="-1" aria-hidden="true">
                                        ...
                                        <form action="<?= base_url('submenu/ubah') ?>" method="post">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            ...
                                                            <input type="text" id="title" name="title" class="form-control" value="<?= $sbmj['title'] ?>" placeholder="Enter title" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            ...
                                                            <input type="text" id="url" name="url" class="form-control" value="<?= $sbmj['url'] ?>" placeholder="Enter URL" />
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" id="id" name="id" class="form-control" value="<?= $sbmj['submenuid'] ?>" placeholder="Enter ID" />
                                ...
                                <!-- Modal Hapus -->
                                <div class="modal fade" id="hapus_modal<?= $sbmj['submenuid'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('submenu/hapus') ?>" method="post">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Apakah anda yakin menghapus data <b><?= $sbmj['menu'] . " dengan sub menu " . $sbmj['title'] ?> ?</b> </p>

                                                    <p>Data yang dihapus tidak dapat dikembalikan.</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <input type="hidden" id="id" name="id" class="form-control" placeholder="Enter ID" value="<?= $sbmj['submenuid'] ?>" />
                                                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                                        Close
                                                    </button>
