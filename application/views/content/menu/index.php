        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="float-end">
                            <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="tambah-modal">Tambah</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <?php foreach ($menu as $m) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#hapusmodal<?= $m['id'] ?>">Ubah</a>
                                    </td>
                                </tr>
                                        <!-- Modal Ubah -->
                                <div class="modal fade" id="ubahmodal<?= $m['id']?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('content/menu/ubah')?>" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modallabel1">Ubah Menu</h5>
